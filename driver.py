...
Q_1 = Query(1, 500000, 472518.0, 4201118.0, 482000.0, 4206000.0)
Q_1.episodes = 'CAR'
Q.append(Q_1)

Q_2 = Query(2, 500000, 473318.0, 4201118.0, 480000.0, 4209000.0)
Q_2.episodes = 'CAR'
Q.append(Q_2)
...
print(Q_1, Q_2.realx1, Q_2.realx2, Q_1.realy2)
